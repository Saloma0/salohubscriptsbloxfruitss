if (game:GetService("CoreGui")):FindFirstChild("SaloHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).SaloHub:Destroy();
...
ImageButton.Image = "rbxassetid://86450702839792";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("SaloHub")).Enabled = not (game.CoreGui:FindFirstChild("SaloHub")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Image = "rbxassetid://86450702839792";
	Title.Parent = Frame;
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("SaloHub") then
			makefolder("SaloHub");
		end;
		if not isfolder("SaloHub/Library/") then
			makefolder("SaloHub/Library/");
		end;
		if not isfile(("SaloHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SaloHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SaloHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("SaloHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("SaloHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local SaloHub = Instance.new("ScreenGui");
	SaloHub.Name = "SaloHub";
	SaloHub.Parent = game.CoreGui;
	SaloHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = SaloHub;
